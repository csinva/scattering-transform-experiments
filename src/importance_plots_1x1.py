...
parser.add_argument('--arch', '-a', metavar='ARCH', default='alexscat_fnum_n2')
...
model = models.__dict__[args.arch](num_classes=100,n=32,j=2,l=args.l,extra_conv=args.extra_conv)
model = torch.nn.DataParallel(model).cuda()
model.load_state_dict(best_ascat['state_dict'])


if args.l < 4 or args.extra_conv != 0:
...
model2 = models.__dict__[args.arch](num_classes=100,n=32,j=2,l=args.l,extra_conv=args.extra_conv)
