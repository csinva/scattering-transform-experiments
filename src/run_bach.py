...
parser.add_argument('--ascat_j',type=int, default=0, help = "parameter for scat layer")
parser.add_argument('--ascat_l', type = int, default = 0, help="parameter for scat layer")
parser.add_argument('--extra_conv', type = int, default = 0, help="parameter for adding more conv layers in alexscat_fnum_n2")
...
# Miscs
parser.add_argument('--manualSeed', type=int, help='manual seed', default = 13)
...
def main():
    ...
    transform_train = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize((182.82091190656038, 157.3296963620186, 214.87577695210769), (38.087092807950555, 44.85998774545851, 22.939518040097095))
    ])
